...
class ButtonAnimator extends React.Component {
  animatedValues = [];
  animatedColorValues = [];
  animations = [];
  ...
  handlePress = () => {
    // Trigger the onClick function passed as a prop
    if (this.props.onClick) {
      this.props.onClick();
    }

    // Optionally, you can add animation or other logic here
  };
  render() {
    return (
      <View>
